        ...
        <div className="relative aspect-3/4 bg-slate-100 overflow-hidden">
          <img
            ...
            className={`w-full h-full object-contain ${
              book.sold ? "opacity-60 grayscale-30" : ""
            }`}
          />
          {book.sold && (
      ...
      {showOwnerActions && isOwner && !book.sold && (
        <div className="px-3 pb-3 flex flex-wrap gap-2 border-t border-slate-100 pt-3">
          <button
            ...
            className="flex-1 min-w-25 text-xs font-semibold py-2 rounded-lg bg-amber-50 text-amber-800 hover:bg-amber-100 disabled:opacity-50"
          >
